...
# ==========================================================================================================
        ...
        contour_image = np.zeros_like(current_frame)
        cv2.drawContours(contour_image, contours, -1, (255), thickness=cv2.FILLED)
        
        concatenated_frames = cv2.hconcat([current_frame, contour_image])
        
        cv2.imshow('Original vs contour detected Frame', concatenated_frames)
        cv2.waitKey(1)
