...
if __name__ == "__main__":
    ...
    excluded_files = ["Exp_1_2_OG_Canny_BGS.py","Exp_1_3_OG_BGS_Lap.py","Exp_1_4_OG_Lap_BGS.py","Exp_1_6_OG_Sobel_BGS.py"]  # Replace with the names of scripts to exclude
    target="Exp_1_"
    ...
    log_path=f'./All_Batch_scripts/batch_logs/{model_folder}.log'
