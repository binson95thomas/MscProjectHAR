...
def execute_python_scripts(folder_path):
    ...
    for script in python_scripts:
        ...
        with open('./All_batch_scripts/batch_prep_exp2.log', 'a') as log_file:
...
if __name__ == "__main__":
    folder_path = "./Full_DB_Prep/Exp_2"  # Replace with the path to your folder containing Python scripts
