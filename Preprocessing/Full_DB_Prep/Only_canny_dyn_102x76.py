...
class OpticalFlowComputer:
    ...
    def compute_edge_detector(self, current_frame):
        ...
        equ_curr_frame= cv2.equalizeHist(current_frame)
        fgmask_curr = self.fgbg.apply(equ_curr_frame)
        ...
        current_frame_masked = cv2.bitwise_and(
            equ_curr_frame, equ_curr_frame, mask=fgmask_curr
        )
         #canny
        blurred_img = cv2.blur(equ_curr_frame,ksize=(5,5))
...
if __name__ == "__main__":
    try:
        ...
        output_folder = "../Outputs/BGS_Canny_dyn_76"
