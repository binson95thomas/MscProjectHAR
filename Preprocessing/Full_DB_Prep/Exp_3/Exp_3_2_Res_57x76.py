...
class OpticalFlowComputer:
    ...
    def compute_edge_detector(self, current_frame):
        ...
        resized_frame = cv2.resize(current_frame_masked, (76, 57))
...
def logging_output(message, file_path='../Outputs/Exp_3_2_Res_57x76/log.txt'):
    try:
    # Write to file
        now = datetime.now()
        current_time = now.strftime("%H:%M:%S")
...
if __name__ == "__main__":                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
    try:
        ...
        output_folder = "../Outputs/Exp_3_2_Res_57x76/Unbalanced"
