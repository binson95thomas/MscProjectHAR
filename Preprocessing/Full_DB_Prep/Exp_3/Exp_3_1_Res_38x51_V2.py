...
def logging_output(message, file_path='../Outputs/Exp_3_1_Res_38x51_V2/log.txt'):
    try:
    # Write to file
        now = datetime.now()
        current_time = now.strftime("%H:%M:%S")
...
if __name__ == "__main__":
    model_type=f"Exp_3_1_Res_38x51_V2"   
    # Created to rerun again since the v1 was corrupted. There was another reason which i dont remember now                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
    try:
        dataset_folder = "../UP-Fall"
        output_folder = f"../Outputs/Exp_3_1_Res_38x51_V2/Unbalanced"
