...
if __name__ == "__main__":
    try:
        ...
        features_path = f'C:\\Users\\bt22aak\\GPU_DS\\Exp_6\\{model_folder}\\Balanced'
        test_path = f'C:\\Users\\bt22aak\\GPU_DS\\Exp_6\\{model_folder}\\Unbalanced'
        ...
        for i in [0.01,0.001,0.0001,0.000001]:
            ...
            print(f"learining rate of {i}")

            logging_output(f"learinng rate of {i}",log_path)
