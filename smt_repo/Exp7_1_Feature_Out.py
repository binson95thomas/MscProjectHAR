...
def train_model(dataloader_train1, dataloader_val1,dataloader_train2, dataloader_val2, num_epochs=50, learning_rate=0.001, weight_decay=1e-5):
    ...
    for epoch in range(num_epochs):
        ...
        if f1 > best_f1_score or (f1 == best_f1_score and accuracy > best_accuracy):
            ...
            best_epoch = epoch
            torch.save(model.state_dict(), f"{saved_model_path}_best_model) # type: ignore # type: ignore
...
if __name__ == "__main__":
    try:
            ...
            model_sub_folder="CNN_256xFC_512_Channel_Contour"
            if lbool_model_sub:
            ...
            prep_out_raw="Exp_6_3_Baseline_128x96_80_split"
            ...
            str_model_type=f'{model_folder_main}_b{batch_size}e{num_epochs}L{learning_rate}'
