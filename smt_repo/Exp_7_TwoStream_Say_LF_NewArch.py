...
def plot_metrics(accuracies, precisions, recalls, specificities, f1_scores, val_losses, train_losses):
    ...
    savepath=f'Results/{model_folder1}/plt_{str_model_type}.png'
...
def plot_confusion_matrix(true_labels, predictions, classes):
    ...
    plt.savefig(f'./Results/{model_folder1}/CM_{str_model_type}.png')
    # plt.show()
...
def logging_output(message, File_dir='./', file_name='def_log.txt'):
    try:
...
if __name__ == "__main__":
    try:
            ...
            model_folder1=name_only[0]
            # model_folder1="TwoStr_LateFusionChannelwise"
            model_folder2="Exp_10_1_Contour_OF"

            log_dir=f'./Results/{model_folder1}/'
            ...
            OF_Stream_path = "D:/UH_KTP/Outputs/Exp_6_2_BG+OF_Baseline_80_Split/balanced"

            Raw_test_path = f'D:/UH_KTP/Outputs/Exp_6_1_Baseline_80_Split/unbalanced'
            OF_Test_path = f'D:/UH_KTP/Outputs/Exp_6_2_BG+OF_Baseline_80_Split/unbalanced'
            ...
            str_model_type=f'{model_folder1}_b{batch_size}e{num_epochs}L{learning_rate}'

            if not os.path.exists(f'./Results/{model_folder1}'):
                try:
                    # Create the directory and its parents if they don't exist
                    os.makedirs(f'./Results/{model_folder1}')
                except OSError as e:
            ...
            model = TwoStreamConv().to(device)
            saved_model_path = f'./Results/{model_folder1}/{str_model_type}.pth'
