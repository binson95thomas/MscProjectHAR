...
if __name__ == "__main__":
    try:
            ...
            model_folder1="TwoStr_Baseline_x_Contour_Research"
            model_folder2="Exp_10_1_Contour_OF"

            log_path=f'./Results/{model_folder1}/Trainlog_UH.log'
            ...
            str_model_type=f'_{model_folder1}_b{batch_size}e{num_epochs}L{learning_rate}'
