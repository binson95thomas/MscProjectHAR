...
if __name__ == "__main__": 
    features_path = '../GPU_DS/bal_BGS_lap_102x76'
    log_path='./Results/log_lap_76.txt'
    ...
    if torch.cuda.is_available() :
        ...
        print(f"CPU Only")
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    str_model_type=f'Bal+BGS+Lap+size(102x76)_b{batch_size}e{num_epochs}L{learning_rate}'
