...
if __name__ == "__main__": 
    features_path = 'C:\\Users\\bt22aak\\Desktop\\BGS_Canny_50_150_38x51'
    test_path = 'C:\\Users\\bt22aak\\Desktop\\ubl_BGS_Canny_50_150_38x51'
    batch_size=32
    num_epochs=50
    learning_rate=0.001
    str_model_type=f'new_tr_BGS+Canny_50_150+(38X51)_b{batch_size}e{num_epochs}L{learning_rate}'
    ...
    print(f"Total Time taken: {code_start - timer()}")
    logging_output(f"Total Time taken: {code_start - timer()}", log_path)
