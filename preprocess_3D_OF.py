...
class OpticalFlowComputer:
    ...
    def compute_optical_flow(self, prev_frame, current_frame):
        ...
        #canny
        edge_frame_curr =cv2.Canny(current_frame,100,150)
        edge_frame_prev=cv2.Canny(prev_frame,100,150)
        #-------------------------------------------------
        # Laplacian
        ...
        # prev_frame = cv2.medianBlur(prev_frame_masked, 5)
        # current_frame = cv2.medianBlur(current_frame_masked, 5)
        prev_frame = cv2.medianBlur(edge_frame_prev, 5)
        current_frame = cv2.medianBlur(edge_frame_curr, 5)
        #====================================================================
