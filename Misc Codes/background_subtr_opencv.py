...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_video",
        type=str,
        help="E:\Cloud Sync\OneDrive - University of Hertfordshire\ProjectWorkables\Reference_codes\OpenCV_Code\learnopencv\Background-Subtraction\street_traffic.mp4",
